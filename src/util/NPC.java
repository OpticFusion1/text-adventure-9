...
enum NPC implements Interactable {
  ...
  MOM ("Mom", Location.VILLAGE, Collections.singletonList("mother")) {
    ...
    String talkToMessage(final GameState GS) {
      if (GS.gotArmor()) {
        ...
        return "Mom: “Hope you're having a great adventure!”";
      }
      else {
  ...
  CREEK_MAN ("Man", Location.CREEK, Collections.singletonList("young man")) {
    ...
    String talkToMessage(final GameState GS) {
      if (!GS.bag().contains(Item.FISH)) {
        ...
        GS.completedFedBro();
        return "Man: “Is that fish I smell! From my brother? I should apologize… " +
            "But thanks. It's not much, but if you find my boots, you're welcome to have them if you'd like!”";
      }
      else {
        ...
        return "Man: “More fish! Thank you! I don't really have much, but here have some water.”";
      }
    }
  },
  FISHERMAN ("Fisherman", Location.RIVER_HUT, Arrays.asList("man", "fisher")) {
    @Override
    String talkToMessage(final GameState GS) {
      return "Fisherman: “My brother and I got into a fight. He's run off to who knows where. " +
          "He's so stubborn sometimes. Take as much fish as you'd like, but please take some to him if you can.”";
    }
  },
  BOY ("Boy", Location.SOUTHERN_FOREST, Arrays.asList("small boy", "young boy", "little boy")) {
    ...
    String talkToMessage(final GameState GS) {
      ...
      return "Boy: “I love coming here to play with my animal friends! I wonder if dad gets worried though…”";
    }
  },
  GIRL ("Girl", Location.WESTERN_ROAD, Arrays.asList("small girl", "young girl", "little girl")) {
    ...
    String talkToMessage(final GameState GS) {
      if (GS.bag().contains(Item.CAT)) {
        ...
        return "Small girl: “Thank you so much for finding my kitty! You're a nice man!”";
      }
  ...
  BLACKSMITH ("Blacksmith", Location.QUEENS_CITY, Collections.singletonList("smith")) {
    ...
    String talkToMessage(final GameState GS) {
      if (GS.helpedDave() && !GS.gotSword()) {
        ...
        return "Blacksmith: “So Dave said he'd give you his sword, eh? " +
            "Well he's already paid so I guess I don't care who it goes to.”";
      }
      else if (!GS.helpedDave()) {
        return "Blacksmith: “I'm holding a sword for Dave. Hopefully he comes to pick it up soon.”";
      }
      else {
  ...
  GROCER ("Grocer", Location.QUEENS_CITY, Collections.emptyList()) {
    @Override
    String talkToMessage(final GameState GS) {
      return "Grocer: “Oh! You're the child of the miller from the village! " +
          "I wish I had food to sell you but I've gone bankrupt…”";
    }
  },
  ARTISAN ("Artisan", Location.QUEENS_CITY, Collections.emptyList()) {
    ...
    String talkToMessage(final GameState GS) {
      if (GS.bag().getCount(Item.BANANA) >= 10) {
        ...
        GS.bag().add(Item.NECKLACE);
        return "Artisan: “Bananas! For me! Thank you so much! Here's something I made! I hope it's useful to you.”";
      }
      if (GS.bag().getCount(Item.FISH) >= 10) {
        ...
        GS.bag().add(Item.NECKLACE);
        return "Artisan: “Fish! For me! Thank you so much! Here's something I made! I hope it's useful to you.”";
      }
      else {
        return "Artisan: “The grocer's foods were the only ones in town I could afford. " +
            "Ever since he went bankrupt I've been unable to feed my family of 10.”";
      }
    }
  },
  GUARD ("Guard", Location.QUEENS_CITY, Collections.emptyList()) {
    @Override
    String talkToMessage(final GameState GS) {
      return "Guard: “No one's allowed in. The queen is busy with meetings discussing what " +
  ...
  FIELD_WOMAN ("Woman", Location.OPEN_FIELD, Arrays.asList("young woman", "painter", "artist")) {
    ...
    String talkToMessage(final GameState GS) {
      if (GS.bag().contains(Item.NECKLACE)) {
        ...
        return "Woman: “Is that necklace for me! You're such a thoughtful young man!”";
      }
      else if (GS.bag().contains(Item.RING)) {
        return "Woman: “Umm… I don't know you well enough to marry you I'm sorry. " +
            "If you find any other jewelry though, come talk to me! ;)”";
      }
      else {
        return "Woman: “I like to find the beauty in things. " +
            "Paintings aren't enough though… I could use some new jewelry!”";
      }
    }
  },
  DARREN ("Darren", Location.SMALL_FARM, Collections.singletonList("farmer")) {
    ...
    String talkToMessage(final GameState GS) {
      if (GS.foundBoy()) {
        ...
        return "Darren: “My son's in the forest playing you say? " +
            "Well I'm just relieved to know where he is. " +
            "Thank you for keeping an eye on him. Here have some eggs.”";
      }
      else {
        return "Darren: “My boy's always disappearing on me. I hope he's okay.”";
      }
    }
  },
  BOBBI ("Bobbi", Location.SOUTHERN_ROAD, Collections.singletonList("woman")) {
    ...
    String talkToMessage(final GameState GS) {
      if (GS.helpedDave()) {
        return "Bobbi: “I can't believe Dave is letting you have our sword…”";
      }
      else {
        GS.bag().add(Item.ROPE);
        return "Bobbi: “Dave and I are buying a sword from the blacksmith in Queen's City. We're " +
            "planning on killing the dragon that has been stealing our livestock. " +
            "If you'd like to help, gather some supplies. Here's some rope to start out.”";
      }
    }
  },
    ...
    String talkToMessage(final GameState GS) {
      if (GS.helpedDave()) {
        ...
        if (GS.bag().contains(Item.FLOWERS)) {
          ...
          return "Dave: “You're going to let me have these flowers for my anniversary gift! " +
              "I am truly indebted to you! I know! Why don't I let you have my sword! " +
              "Just talk to the blacksmith in Queen's City. He's holding it for me.”";
        }
        else {
